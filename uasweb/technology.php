...
// Function to fetch trending technology posts
function fetchTrendingTechPosts($conn) {
...
// Fetch recent technology posts and trending technology posts
$recentPosts = fetchRecentTechPosts($conn, $limit, $offset); // Adjust limit and offset as needed
$trendingPosts = fetchTrendingTechPosts($conn);

// Fetch total number of technology posts for pagination
$totalPostsResult = $conn->query("SELECT COUNT(*) as total FROM posts WHERE kategori = 'technology'");
            ...
            <div class="swiper mySwiper h-[590px] text-center">
                <div class="swiper-wrapper">
                    ...
                    <div class="swiper-slide">
                        <h1 class="text-4xl font-bold uppercase mb-6"><?php echo htmlspecialchars($recentPost['judul']); ?></h1>
...
<section>
    <div class="container mx-auto px-4">
        <h1 class="text-3xl font-bold text-center my-8">Recent Technology Posts</h1>
            ...
            <div class="border rounded-lg overflow-hidden shadow-md">
                ...
                <div class="p-4">
                    <h2 class="text-xl font-bold">
                        <a href="artikel.php?id=<?php echo $post['id']; ?>" class="text-blue-500 hover:underline">
                            <?php echo htmlspecialchars($post['judul']); ?>
                        </a>
                    </h2>
                    <p class="mt-2 text-gray-600"><?php echo nl2br(htmlspecialchars($post['isi'])); ?></p>
                    <p class="text-sm text-gray-500 mt-2">Views: <?php echo htmlspecialchars($post['view']); ?></p>
                </div>
            </div>
            <?php endwhile; ?>
        <</div>
...
<footer class="bg-gray-800 text-white py-4">
    <div class="container mx-auto text-center">
        <p>&copy; <?php echo date("Y"); ?> Pemrograman Web. All rights reserved.</p>
    </div>
</footer>
